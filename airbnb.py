...
groupby_proresult = filtered_pro.groupby(["room_type", "neighbourhood_cleansed"])[
    ["price", "POST_price", "review_scores_rating", "POST_review_scores_rating"]
].mean()
...
groupby_proresult_filtered = groupby_proresult[
    groupby_proresult.index.get_level_values("neighbourhood_cleansed").isin(qualified_neighbourhoods)
]
...
groupby_proresult_plot = groupby_proresult[
    groupby_proresult.index.get_level_values("neighbourhood_cleansed").isin(final_target_neighbourhoods)
]
groupby_convresult_plot = groupby_convresult[groupby_convresult.index.isin(final_target_neighbourhoods)]

groupby_proresult_plot = groupby_proresult_plot.reindex(final_target_neighbourhoods, level='neighbourhood_cleansed')
groupby_convresult_plot = groupby_convresult_plot.reindex(final_target_neighbourhoods)

neighbourhoods = groupby_proresult_plot.index.get_level_values("neighbourhood_cleansed")  # 地域名
